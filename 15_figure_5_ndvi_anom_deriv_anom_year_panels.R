...
usdm_dates <- read.csv(file.path(google.drive, "Manuscript - Urban Drought NDVI Monitoring by Land Cover Class/tables/USDM_dates_case_study_years.csv"))
# plot --------------------------------------------------------------------
...
ggsave("figure_5_NDVI_anoms_and_deriv_anoms_panels_case_study_years.png", path = pathShare, height=15, width=21, units="in", dpi = 320)
